...
class MomentumOptimizer : public OptimizerBase1 {
 private:
  ll_optimizer_t::MomentumConfig config_;

 public:
  DEFINE_OPTIMIZER_LIKE(MomentumOptimizer);
...
OPTIMIZER_REGISTER(MomentumOptimizer, "MomentumOptimizer");
OPTIMIZER_REGISTER(MomentumOptimizer, "momentum");
