...
class RMSPropOptimizer : public OptimizerBase1 {
 private:
  ll_optimizer_t::RMSPropConfig config_;

 public:
  DEFINE_OPTIMIZER_LIKE(RMSPropOptimizer);
...
OPTIMIZER_REGISTER(RMSPropOptimizer, "RMSPropOptimizer");
OPTIMIZER_REGISTER(RMSPropOptimizer, "rmsprop");
