...
class WePSAdaDeltaOptimizer : public WePSOptimizerBase2 {
 private:
  ll_we_ps_optimizer_t::AdaDeltaConfig config_;

 public:
  DEFINE_WE_PS_OPTIMIZER_LIKE(WePSAdaDeltaOptimizer);
...
WE_PS_OPTIMIZER_REGISTER(WePSAdaDeltaOptimizer, "WePSAdaDeltaOptimizer");
WE_PS_OPTIMIZER_REGISTER(WePSAdaDeltaOptimizer, "ada_delta");
WE_PS_OPTIMIZER_REGISTER(WePSAdaDeltaOptimizer, "adadelta");
