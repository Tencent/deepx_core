...
class WePSRMSPropOptimizer : public WePSOptimizerBase1 {
 private:
  ll_we_ps_optimizer_t::RMSPropConfig config_;

 public:
  DEFINE_WE_PS_OPTIMIZER_LIKE(WePSRMSPropOptimizer);
...
WE_PS_OPTIMIZER_REGISTER(WePSRMSPropOptimizer, "WePSRMSPropOptimizer");
WE_PS_OPTIMIZER_REGISTER(WePSRMSPropOptimizer, "rmsprop");
